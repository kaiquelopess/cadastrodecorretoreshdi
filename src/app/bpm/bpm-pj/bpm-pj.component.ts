...
import { CorretoresService } from 'src/app/services/corretores.service';
...
@Component({
  selector: 'app-bpm-pj',
  templateUrl: './bpm-pj.component.html',
  styleUrls: ['./bpm-pj.component.css']
})

export class BpmPjComponent implements OnInit {
