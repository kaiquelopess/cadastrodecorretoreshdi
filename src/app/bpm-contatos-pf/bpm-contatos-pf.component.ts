...
@Component({
  selector: 'app-bpm-contatos-pf',
  templateUrl: './bpm-contatos-pf.component.html',
  styleUrls: ['./bpm-contatos-pf.component.css']
})
export class BpmContatosPfComponent implements OnInit {
  ...
  consultaDados() {
    ...
    this.consultaDadosService.consultaDados(this.susep, this.cpfCnpj).subscribe(
      response => {
        ...
        sessionStorage.setItem('cpfUsuario', results.cpf);
